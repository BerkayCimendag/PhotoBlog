    ...
    public partial class InıtialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 1, 11, 14, 38, 23, 941, DateTimeKind.Local).AddTicks(7888), "As the sun sets behind the hills, I watch the unique blue of the sea.", "sample.jpg", "Mountains & Sea" });
        }
